...
>>>>>>> 5dc8e844042c86eab36fa9ffe16d4e612c53b0a2
      ...
      case 'about':
        return (
          <div className="prose max-w-none mx-auto p-6 rounded-lg leading-relaxed">
            <p>Biju Cheriyan, an Instrumentation and Control Engineering graduate from NSS College of Engineering, was deeply involved in student rights advocacy. The Biju Cheriyan Endowment, a flagship program of Darsana, began in 2008 to support economically disadvantaged students.</p>
            <p>The Endowment offers financial support, mentoring, and academic programs for students, benefitting 40 students annually.</p>
          </div>
        );
      case 'eligibility':
        return (
          ...
          <div className="space-y-4">
            {faqData.map((faq, index) => (
              <div key={index} className="border rounded-md">
                ...
                {openFAQ === index && <div className="p-4 bg-gray-50">{faq.answer}</div>}
              </div>
            ))}
          </div>
        );
        ...
        <div className="container mx-auto px-4">
          ...
          {activeTab !== 'track' && (
            <div className="text-center my-8">
              ...
              {showLoginMessage && <p className='text-red-500 text-center'>You need to sign in to apply</p>}
              <button className="bg-blue-500 text-white px-4 py-2 rounded" onClick={handleApplyClick}>
                APPLY NOW
              </button>
            </div>
          )}

...
const FinalSubmit: React.FC<FinalSubmitProps> = ({ initialEmail }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Append the scholarshipData as a JSON string
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.error || 'Failed to submit scholarship application');
            }
    ...
    const handleDownloadPDF = () => {
        ...
        doc.text(`Downloaded on: ${formattedDate}`, 105, 30, { align: 'center' });
        ...
        // Footer
        doc.setFontSize(10);
        doc.text('Generated for darsana Scholarship System', 105, 290, { align: 'center' });
